  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-syne font-bold tracking-tight text-[#E0E6F4]">{t('myExpenses')}</h1>
          <p className="text-[13px] text-[#8B93A8]">{t('myExpensesDesc')}</p>
        </div>
        <Link href={`/${locale}/expenses/new`} className="inline-flex items-center gap-2 px-4 py-2 bg-[#D4A843] text-[#07091A] rounded-lg text-[13px] font-medium hover:bg-[#C49A3A] transition-colors">
          ...
          <div key={e.id} className="bg-[#0D1028] border border-[rgba(255,255,255,0.065)] rounded-xl p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                <h3 className="text-[13px] font-semibold text-[#E0E6F4]">{e.title}</h3>
                <div className="flex items-center gap-3 mt-1 text-[12px] text-[#8B93A8]">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                <span className="text-[13px] font-bold text-[#E0E6F4]">{e.amount.toFixed(2)} AED</span>
